...
if not os.path.isfile(file_out):
    ...
    ds18_hist = xr.open_dataarray(figpath+'blob_map_35km_hist_MAM_16-17UTC_2006.nc')
    #ds3_present = xr.open_dataarray(path + 'ds_present2004_'+mon+'_3UTC.nc')
    ds18_present = xr.open_dataarray(figpath + 'blob_map_35km_present_MAM_16-17UTC_2011.nc')
...
# coord = [-8,-6,5.5,8,6.9,7.4, -7.6, -7.4]
# # name='playaround'
...
print('temp', pearsonr(ds18_present.values.flatten(), lst_on_ds.values.flatten()))
print('pres,hist', pearsonr((ds2f-ds2f.min())/(ds2f.max()-ds2f.min()), (dsf-dsf.min())/(dsf.max()-dsf.min())))
