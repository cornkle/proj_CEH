...
dic = pkl.load( open ('/users/global/cornkle/data/CLOVER/saves/bulk_-10_zeroRain.p', 'rb')) #MSG_TRMM_temp_pcp_300px2004-2013_new.p', 'rb'))


# In[3]:

_p=np.array(dic['pmax']) # 98th perc per MCS
_t=np.array(dic['tmean'])  #mean T
...
mappable = ax1.scatter(t, p, c=test, edgecolor='', cmap='viridis_r', s=20) # viridis_r
...
plt.tight_layout()
plt.savefig(path+'scatter-10_gt324_tmean.png')
