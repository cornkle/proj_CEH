...
def perSys():
    ...
    tthresh = '-50'
    files = ua.locate(".nc", cnst.network_data +'data/CP4/CLOVER/MCS25_-50_5000km2')
    ...
    pkl.dump(mdic, open(cnst.network_data +'data/CLOVER/saves/bulk_'+tthresh+'_zeroRain_gt1k_shear_CP25.p',
                           'wb'))
