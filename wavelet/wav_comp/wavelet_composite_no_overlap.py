...
def composite():
    ...
    dic = OrderedDict([('scale', []), ('id' , []), ('hour' , []),
           ('clat',[]), ('clon',[]),('lat_min',[]), ('lat_max' , []), ('lon_min' , []), ('lon_max' , []), ('area' , []),
           ('bulk_pmax' , []), ('bulk_pmean' ,[]), ('bulk_tmean',[]), ('bulk_tmean_p',[]), ('bulk_tmin_p',[]), ('bulk_g30',[]),
            ('circle_Tcentre', []), ('circle_p' , []), ('circle_t' , []), ('circle_val' , []), ('circle_sum' , []),
           ('circle_nz' , []), ('circle_g30' , []), ('circle_max' , []), ('circle_p99' , []), ('circle_p95' , []), ('circle_p90' , [])])
    ...
    pkl.dump(comp_collect, open(out + 'comp_collect_composite_noC_masked.p', 'wb'))

    pkl.dump(np.unique(ids), open(out + 'ids_noC.p', 'wb') )
...
def file_loop(fi):
    ...
    dic2 = pkl.load(open('/users/global/cornkle/C_paper/wavelet/saves/pandas/ids_T.p', 'rb'))
    ...
    for y, x, sc in zip(yyy, xxx, scal):
        ...
        figure[ycircf[pos], xcircf[pos]] = 0
