...
def file_loop(fi):
    ...
    alt_path = '/media/ck/LStorage/AMSR2/daily/25km/night_anom/'
...
def plot(h):
    h = h - (MREGIONS[REGION])[2]
    print('Hour: ', h)
    pin = cnst.network_data + 'data/GLOBAL_MCS/save_files_old/' + "/" + REGION + "_AMSR2-global_2012-2019_SM_MCSTRACK_BOX-ANNUAL_PF_"
    ...
    plt.tight_layout()
    f.savefig('/home/ck/DIR/cornkle/figs/GLOBAL_MCS/old_composites/'+REGION+'_'+str(y1)+'-'+str(y2-1)+'_SM_composite_AMSR2-global_BOX-ANNUAL_PF.jpg')