...
data_path = main + '/CP4_WestAfrica/CP4hist'
ancils_path = main + '/CP4_WestAfrica/ANCILS'
out_path = main + '/MCS_files/MODELS/CP4/CP4_allHours_historical_5000km2_-50_WAf'
...
vars['lh'] = ([], 12, (inds,weights,shape))
vars['t2'] = ([], 12, (inds,weights,shape))
vars['q2'] = ([], 12, (inds,weights,shape))
