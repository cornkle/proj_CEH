...
from utils import u_darrays as uda, u_interpolate as u_int
...
main_lmcs = '/home/users/cornkle/lmcs/cklein/CP_models'
data_path = main +fdir
ancils_path = main + '/ANCILS_4km'
out_path = main_lmcs + '/MCS_files/CP4_box_anom/CP4_allHours_'+ftag+'_5000km2_-50_WAf_box_anom_v2'
...
# load seamask
landsea_path = glob.glob(ancils_path + '/ANCILS/landseamask*.nc')[0]
...
###########
topo_path = glob.glob(ancils_path + '/ANCILS/orog_combined*.nc')[0]
