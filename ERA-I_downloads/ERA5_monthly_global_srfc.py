...
def download(year):
    ...
    c.retrieve(
        ...
        '/media/ck/LStorage/global_water/other/ERA5_global_0.7/monthly/surface/ERA5_monthly_0.7deg_'+str(year)+'.nc')

for y in range(2022,2023):
    if os.path.isfile('/media/ck/LStorage/global_water/other/ERA5_global_0.7/monthly/surface/ERA5_monthly_0.7deg_'+str(y)+'.nc'):
        continue
    download(y)
